...
>>>>>>> cd1a7baee7b8774bd896730b1000494b63701a81
const App = () => {
  const { isColorModeSet, setColorMode } = useColorModes('dark'); // Set 'dark' as default mode
  ...
  useEffect(() => {
    ...
    setColorMode(storedTheme || 'dark'); // Set 'dark' if no stored theme is found
